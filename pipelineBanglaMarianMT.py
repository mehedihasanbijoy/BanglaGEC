...
if __name__ == "__main__":
	...
	sys.stdout = open('/home/uiu/nlp/GEC/BanglaGEC/outputs/pipelineMarianMT.txt', 'w')
	...
	for (input_ids, attention_mask, target_ids) in test_loader:
		...
		# prd_text = [punctuations_preprocessing(prd_text[0])]
		# trg_text = [punctuations_preprocessing(trg_text[0])]
